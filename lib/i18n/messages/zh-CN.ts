...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chat": "对话",
    "settings.quoteSelection": "选中文本后显示操作",
    ...
    "settings.subagentsDescription": "Pi Web 如何运行子代理会话，以及可用的配置档案。",
    "settings.subagentsBuiltIn": "内置子代理",
    "settings.subagentsBuiltInDescription": "在进程内运行子代理，不经过额外的辅助进程。",
    "settings.subagentsMaxConcurrent": "最大并发子代理",
    "settings.subagentsMaxConcurrentDescription": "同时最多可以运行多少个子代理。",
    "settings.subagentsProfiles": "配置档案",
    "settings.subagentsProfilesDescription": "配置档案由代理目录与项目目录下的 markdown 文件定义。",
    "settings.subagentsProfilesEmpty": "未找到子代理配置档案",
    "settings.subagentsProfileDisabled": "已禁用",
    "settings.subagentsScope.builtin": "内置",
    "settings.subagentsScope.global": "全局",
    "settings.subagentsScope.workspace": "工作区",
    "settings.subagentsScope.project": "项目",
    "settings.subagentsReloadDescription": "重载当前会话以刷新它的 Agent 工具。",
    "remote.nav": "远程访问",
    "remote.title": "远程访问",
    ...
    "sidebar.changes": "变更",
    "sidebar.refreshChanges": "刷新变更",
    "sidebar.moreChangedFiles": "还有 {count} 个",
    ...
    "chat.agentPlaceholderMobile": "列表排队 · 箭头插话",
    "chat.runningDraftPlaceholder": "Enter 排队 · 实心按钮插话当前回合",
    "chat.runningDraftPlaceholderMobile": "列表排队 · 箭头插话",
    ...
    "chat.queue": "排队",
    "chat.queueTitleMobile": "排队，等这轮结束后发送",
    ...
    "chat.interject": "插话",
    "chat.send": "发送",
    "chat.locateAssistant": "定位助手消息",
    "chat.attachedImage": "附件图片 {n}",
    "chat.askSelection": "就选中文本提问",
    "chat.askInCurrent": "在当前对话提问",
    "chat.askInNewChat": "在新对话提问",
    "chat.newQuoteChat": "就选中文本开新对话",
    ...
    "models.discard": "放弃",
    "models.usageTitle": "用量",
    "models.usageError": "无法加载用量。",
    "models.usageEmpty": "暂无用量数据。",
    "models.usageRefresh": "刷新",
    "models.usagePlan": "{plan}",
    "models.usageWindowUsed": "已用 {percent}%",
    "models.usageReset": "{when} 后重置",
    "models.usage.window.five_hour": "5 小时",
    "models.usage.window.seven_day": "7 天",
    "models.usage.window.credit": "额度",
    "models.usage.window.primary": "用量",
    "models.usage.window.premium": "高级",
    "models.usage.window.quota": "配额",
