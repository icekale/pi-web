...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.subagentsDescription": "How Pi Web runs subagent sessions, and the profiles they can use.",
    "settings.subagentsBuiltIn": "Built-in subagents",
    "settings.subagentsBuiltInDescription": "Run subagents in-process instead of through a separate helper process.",
    "settings.subagentsMaxConcurrent": "Max concurrent subagents",
    "settings.subagentsMaxConcurrentDescription": "How many subagents may run at the same time.",
    "settings.subagentsProfiles": "Profiles",
    "settings.subagentsProfilesDescription": "Profiles are defined by markdown files in the agent and project directories.",
    "settings.subagentsProfilesEmpty": "No subagent profiles found",
    "settings.subagentsProfileDisabled": "disabled",
    "settings.subagentsScope.builtin": "built-in",
    "settings.subagentsScope.global": "global",
    "settings.subagentsScope.workspace": "workspace",
    "settings.subagentsScope.project": "project",
    "settings.subagentsReloadDescription": "Reload the running session to refresh its Agent tool.",
    ...
    "layout.skipToChat": "Skip to chat",
    ...
    "sidebar.refreshChanges": "Refresh changes",
    "sidebar.moreChangedFiles": "+{count} more",
    ...
    "chat.waitingUser": "Waiting for you...",
    ...
    "chat.queue": "Queue",
    "chat.queueTitleMobile": "Queue until this turn ends",
    ...
    "chat.send": "Send",
    "chat.locateAssistant": "Locate assistant message",
    "chat.attachedImage": "Attached image {n}",
    ...
    "models.usageTitle": "Usage",
    "models.usageError": "Could not load usage.",
    "models.usageEmpty": "No usage data.",
    "models.usageRefresh": "Refresh",
    "models.usagePlan": "{plan}",
    "models.usageWindowUsed": "{percent}% used",
    "models.usageReset": "resets in {when}",
    "models.usage.window.five_hour": "5-hour",
    "models.usage.window.seven_day": "7-day",
    "models.usage.window.credit": "Credits",
    "models.usage.window.primary": "Usage",
    "models.usage.window.premium": "Premium",
    "models.usage.window.quota": "Quota",
